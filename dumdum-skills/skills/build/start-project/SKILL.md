...
> "I'm creating **[filename]** — this is [plain English explanation]. [Why it's needed]."
...
- For an API: "Your server is now running and listening for requests at **[URL]**. It's like a shop that just opened its doors — it's waiting for customers (requests) to come in."
