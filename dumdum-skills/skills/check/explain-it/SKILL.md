...
> This part handles what happens when something goes wrong. Instead of your project just crashing, this catches the problem and [what it does, e.g., shows an error message, tries again, etc.].
...
>
> **The Big Picture**
> "Your project is a [type of project, e.g., website, app, tool, etc.] that [what it does in one sentence]. It's built using [technology in plain English, e.g., 'a popular toolkit for building websites called React' not just 'React']."
>
