...
Look in the current conversation and working directory for any existing project context, such as a feature list, project description, previous DumDum skill output, or any files that describe what the user is building.
